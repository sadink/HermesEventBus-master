...
package com.lhfboy.library.hermeseventbus;
...
import com.lhfboy.library.concurrentutils.ObjectCanary2;
import com.lhfboy.library.concurrentutils.util.Action;
import com.lhfboy.library.concurrentutils.util.Function;
...
public class HermesEventBus {
    ...
    private com.lhfboy.library.hermes.HermesListener hermesListener;
    ...
    public void setHermesListener(com.lhfboy.library.hermes.HermesListener hermesListener){
    ...
    public class HermesListener extends com.lhfboy.library.hermes.HermesListener {
